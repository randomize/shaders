	...
	SubShader 
	{
		...
		float _RimPower;
			...
			void surf (Input IN, inout SurfaceOutput o) {
				...
				//fixed4 Fresnel = (1.0 - dot( normalize( fixed3(IN.viewDir.x, IN.viewDir.y,IN.viewDir.z)), normalize( fixed3(0,0,1) ) )).xxxx;
